...
VALUES (XXXX, 'gw_fct_insert_importgpkg', 'utils', 'function', 'json', 'json','This function to import dxf files into a Giswater schema works using the DXF layername(s) AS Giswater catalogs. 
...
INSERT INTO sys_function(id, function_name, project_type, function_type, input_params, return_type, descript, sys_role, sample_query, source)
VALUES (XXXX, 'gw_fct_insert_importgpkg', 'utils', 'function', 'void', 'json','Function to check the quality of imported DXF files',
'role_edit', null, 'gw_import_dxf')ON CONFLICT (id) DO NOTHING;


INSERT INTO sys_fprocess(fid, fprocess_name, project_type, source)
VALUES (XXX, 'Manage dxf file', 'utils', 'gw_import_gpkg' )ON CONFLICT (fid) DO NOTHING;